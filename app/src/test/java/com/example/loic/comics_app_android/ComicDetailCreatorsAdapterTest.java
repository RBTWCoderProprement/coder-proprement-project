...
public class ComicDetailCreatorsAdapterTest {
    @Test
    public void comicDetaileCreatorsAdapterTest(){
        ...
        ComicDetailCreatorsListAdapter adapter = new ComicDetailCreatorsListAdapter(comic.getResults().get(0).getCreators());
